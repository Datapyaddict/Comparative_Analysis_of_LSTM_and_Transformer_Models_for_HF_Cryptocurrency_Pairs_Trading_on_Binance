...
The Jupyter Notebooks have to be placed in a dedicated folder named "Colab Notebooks" in Google Colab for them to be able to run.
...
<tr>
    ...
    <td rowspan = "2">- Binance API / - time interval = '1m' / - start and end dates of the period for which the market data are fetched.</td>
    <td>Get market data from Binance API.</td>
    <td rowspan = "2">1 hour</td>
    <td rowspan = "2">The database binance_prices3.db at the root of the project folder.</td>
</tr>
...
<tr>
    ...
    <td rowspan = "5">Use the database binance_prices3.db to get market prices.</td>
    <td>Produce the list of the most liquid coins in the in-sample period.</td>
    <td rowspan = "5">30 minutes</td>
    <td> File containing the most liquid coins for the in-sample. Results were used in Table.A7 in the report.
...
<tr>
    ...
    <td>Refined list of cointegrated pairs used in Table.A8 in the report :
...
- Plots displaying the predicted vs actual prices over the out-of-sample. They are used for the plots Figure.6, Figure.7, Figure.9, Figure.10, Figure.12, Figure.13, Figure.15, Figure.16  in the report.
- The models’ performance file (models_performance.csv) used in Table.A9 in the report.
...
Plots of the predicted and actual spreads. They are used to produce Figure.5, Figure.8, Figure.11, and Figure.14 in the report.
...
<tr>
    <td>calculate portfolio results from the 2 trading signals.</td>
</tr>
<tr>
...
-	all_stats.csv is used to produce Table.A10 in the report.
-	all_stats_models.csv is used to produce Table.2 in the report.
...
-	one_sample_result.csv is used to produce Table.6 in the report.
-	one_sample_result_models.csv is used to produce Table.3 in the report.
-	scope.csv is used to produce Table.4 in the report.
-	sharpe_ratio_distribution_plot.png is used to produce Figure.17 in the report.
-	two_samples_result.csv is used to produce Table.5 in the report.
-	two_samples_result_models.csv is used to produce Table.1 in the report.
</td>
</tr>
<tr>
